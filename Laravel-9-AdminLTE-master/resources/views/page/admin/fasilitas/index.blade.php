...
<script>
    $(document).ready(function() {
        $('#previewFasilitas').DataTable({
            "serverSide": true,
            "processing": true,
            "ajax": {
                "url": "{{ route('fasilitas.dataTable') }}",
                "dataType": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}"
            ...
            "columns": [{
                "data": "nama_fasilitas" // ubah disini ya jing
            }, {
                "data": "jumlah"
            }, {
                "data": "options"
        ...
        // hapus data
        $('#previewFasilitas').on('click', '.hapusData', function() {
            var id = $(this).data("id");
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#previewFasilitas').DataTable().ajax.reload();
                            }
                        });
                    }
                })
